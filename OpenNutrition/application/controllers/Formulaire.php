...
class Formulaire extends CI_Controller {
     ...
     */
    private $data["PlatCrous"] = $this->PlatCrous->getPlatCrous();
    ...
    function index() {
        ...
        $this->load->view('AjouterPlat_view', $this->$data);
    ...
    function submitAjout(){
        ...
        $this->form_validation->set_rules('i-ss', 'Sodium', 'required');
